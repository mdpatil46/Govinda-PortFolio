...
function NavBar() {
  ...
  return (
    <>
      <nav class="bg-black border-gray-200 dark:bg-gray-900 dark:border-gray-700 overflow-hidden">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 overflow-x-hidden">
          <Link to="/" class="flex items-center space-x-3 rtl:space-x-reverse hover:animate-spin">
